...
export default function ProductItem({ item }) {
  ...
  function handleDelelteProduct(item) {
    let url = `https://my-json-server.typicode.com/harshalsgore/data/products/${item.id}`;
  ...
  function handleSave(item) {
    ...
    result.then((data) => {
      ...
      dispatchProduct(addproducts([...products]));
      showToastMessage("Edit succesful", "success");
    });
  }
  return (
    //   container
    <div className="d-flex container-sm bg-white px-1 py-5 mt-4 flex-column flex-lg-row gap-3 border border-dark">
      {/* left section  */}
      <ToastContainer />
